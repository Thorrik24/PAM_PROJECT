    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tipo', models.CharField(choices=[('Pokemon', 'Pokemon'), ('Ataque', 'Ataque'), ('Equipo', 'Equipo'), ('Hechizo', 'Hechizo')], default='Pokemon', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Ataque',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('carta_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='PAM_APP.carta')),
                ('TipoHechizo', models.CharField(choices=[('MT', 'MT'), ('MO', 'Mo'), ('Ev', 'Evento')], max_length=6)),
            ],
            bases=('PAM_APP.carta',),
        ),
        migrations.CreateModel(
